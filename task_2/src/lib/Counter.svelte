<script lang="ts">
  ...
  $: convertedAmount = selectedCurrency && conversionRates[selectedCurrency] ? amount * conversionRates[selectedCurrency] : 0;
 </script>
 
 <div>

 <label for="currency">Currency:</label>
 <input id="currency" type="text" bind:value={selectedCurrency} placeholder="Enter currency code">
